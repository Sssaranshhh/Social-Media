...
import { useNavigate } from 'react-router-dom';
 ...
 const EnhancedNavbar=()=> {
  ...
  return (
    <nav className="bg-gradient-to-r  from-gray-900 via-gray-700 to-gray-900 text-white border-b border-gray-700/50 backdrop-blur-sm relative overflow-hidden shrink-0">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 -mt-1">AI Powered Social Platform</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="px-3 py-2 text-gray-300
            hover:text-green-400 hover:border-2 hover:border-green-400 transition-all duration-200 hover:scale-[1.1] font-medium text-sm sm:text-base rounded-2xl " onClick={()=>navigate(`/social/login`)}>
              Login
            </button>
            <button className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-700 hover:from-green-600 hover:to-emerald-800 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-green-500/20 transform hover:scale-[1.1] text-sm sm:text-base" onClick={()=>navigate(`/social/signup`)}>
              Sign Up
            </button>
            ...
            <div className="md:hidden">
              ...
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  {isMenuOpen ? (
                    <path strokeLinecap="square" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" />
                  ) : (
